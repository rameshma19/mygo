...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0x8d, 0x01, 0x0a, 0x0b, 0x43, 0x61, 0x6c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x29, 0x0a, 0x06, 0x44, 0x69, 0x76, 0x69, 0x64, 0x65,
...
var file_service_proto_depIdxs = []int32{
	...
	0, // 1: proto.CalcService.Multiply:input_type -> proto.Request
	0, // 2: proto.CalcService.Divide:input_type -> proto.Request
	1, // 3: proto.CalcService.Add:output_type -> proto.Response
	1, // 4: proto.CalcService.Multiply:output_type -> proto.Response
	1, // 5: proto.CalcService.Divide:output_type -> proto.Response
...
func (c *calcServiceClient) Divide(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.CalcService/Divide", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCalcServiceServer) Divide(context.Context, *Request) (*Response, error) {
...
func _CalcService_Divide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CalcService/Divide",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServiceServer).Divide(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
